...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Survey.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Survey.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_survey())
			{
				...
				Template::redirect(SITE_AREA .'/developer/survey');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/survey');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Survey.Developer.Edit');
		...
		{
			$this->auth->restrict('Survey.Developer.Delete');
