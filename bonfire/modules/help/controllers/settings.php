...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Help.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Help.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_help())
			{
				...
				Template::redirect(SITE_AREA .'/settings/help');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/help');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Help.Settings.Edit');
		...
		{
			$this->auth->restrict('Help.Settings.Delete');
