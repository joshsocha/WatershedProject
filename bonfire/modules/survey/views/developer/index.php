<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Survey.Developer.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Survey.Developer.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/developer/survey/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->survey_poll_name) ?></td>
				<?php else: ?>
