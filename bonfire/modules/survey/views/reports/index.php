<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Survey.Reports.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<tfoot>
				<?php if ($this->auth->has_permission('Survey.Reports.Delete')) : ?>
				<tr>
					<td colspan="4">
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Survey.Reports.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/reports/survey/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->survey_poll_name) ?></td>
				<?php else: ?>
