...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Survey.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Survey.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_survey())
			{
				...
				Template::redirect(SITE_AREA .'/reports/survey');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/survey');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Survey.Reports.Edit');
		...
		{
			$this->auth->restrict('Survey.Reports.Delete');
