...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Survey.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Survey.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_survey())
			{
				...
				Template::redirect(SITE_AREA .'/settings/survey');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/survey');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Survey.Settings.Edit');
		...
		{
			$this->auth->restrict('Survey.Settings.Delete');
