...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Help.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Help.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_help())
			{
				...
				Template::redirect(SITE_AREA .'/content/help');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/help');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Help.Content.Edit');
		...
		{
			$this->auth->restrict('Help.Content.Delete');
