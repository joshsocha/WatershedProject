...
class Migration_Setup_Intermediate_observation extends Migration {

    /**
     * Adds new fields to observation table to allow for intermediate users
     * and post approval. Drops all previous tables in order to modify one
     * and restore foreign keys
     */
    public function up()
    {
    ...
    public function down()
    {
        ...
        //restore tables created in rev 2
        // Table "observation"
        $fields = array(
            'id' => array(
                'type' => 'INT',
