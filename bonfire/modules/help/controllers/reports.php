...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Help.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Help.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_help())
			{
				...
				Template::redirect(SITE_AREA .'/reports/help');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/help');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Help.Reports.Edit');
		...
		{
			$this->auth->restrict('Help.Reports.Delete');
