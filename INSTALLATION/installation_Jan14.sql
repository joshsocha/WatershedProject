...
INSERT INTO bf_activities (`activity_id`, `user_id`, `activity`, `module`, `created_on`, `deleted`) VALUES (35, 1, 'logged in from: ::1', 'users', '2014-01-02 19:19:57', 0);
INSERT INTO bf_activities (`activity_id`, `user_id`, `activity`, `module`, `created_on`, `deleted`) VALUES (36, 1, 'logged in from: 127.0.0.1', 'users', '2014-01-15 01:57:55', 0);
...
INSERT INTO bf_users (`id`, `role_id`, `email`, `username`, `password_hash`, `reset_hash`, `salt`, `last_login`, `last_ip`, `created_on`, `deleted`, `banned`, `ban_message`, `reset_by`, `display_name`, `display_name_changed`, `timezone`, `language`, `active`, `activate_hash`) VALUES (1, 1, 'nobody@nowhere.com', 'Admin', '0fd6b0c95be28eaef791de737f97a99feade8140', NULL, 'CpHHl6c', '2014-01-15 01:57:55', '127.0.0.1', '0000-00-00 00:00:00', 0, 0, NULL, NULL, '', NULL, 'UM6', 'english', 1, '');
